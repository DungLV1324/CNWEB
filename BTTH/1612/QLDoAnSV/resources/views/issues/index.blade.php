    ...
    <div class="table-responsive">
        <div class="table-wrapper">
            <div class="table-title">
                <div class="row">
                    <div class="col-sm-6">
                        <h2> Quản lý phòng thực hành tin học</h2>
                    </div>
            ...
            <table class="table table-striped table-hover">
                ...
                @foreach ($issues as $issue)
                    <tr>
                        ...
                        <td>{{ $issue->status }}</td>
                        <td>
                            <a href="{{ route('issues.edit', $issue->id) }}" class="btn " style="border: 2px solid blue;"><i class="material-icons" data-toggle="tooltip" title="Edit">&#xE254;</i></a>
                        </td>
                        <td>
                            <!-- Nút xóa kèm modal xác nhận -->
                            <button type="button" class="btn" style="border: 2px solid red;" data-bs-toggle="modal" data-bs-target="#deleteModal{{ $issue->id }}">
